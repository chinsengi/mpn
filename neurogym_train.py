...
def train_network_ngym(net_params, dataset_params, current_net=None, save=False, save_root='', 
                        set_seed=True, verbose=True, tasks_masks=None):
        """ 
    ...
    if train:
        for task_idx, task in enumerate(tasks):
            ...
            for trial_idx in range(n_trials):
                ...
                _, net_params = train_network_ngym(net_params, dataset_params, save=save, 
                                                    save_root=save_root, verbose=verbose, tasks_masks=tasks_masks)
    else:
